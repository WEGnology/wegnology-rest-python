...
import json
import sys
from wegnologyrest import Client, WegnologyError
...
class TestClient(unittest.TestCase):
    ...
    def test_basic_call_no_auth(self, mock):
        ...
        creds = {"email": "example@wnology.io", "password": "qwerqwer"}
        mock.post("https://api.app.wnology.io/auth/user", json=expected_body)
    ...
    def test_basic_call_with_auth(self, mock):
        ...
        expected_qs = {"_links": ["true"], "_actions": ["false"], "_embedded": ["true"]}
        mock.get("https://api.app.wnology.io/applications/anapp/devices/adevice", json=expected_body)
    ...
    def test_failure_call(self, mock):
        ...
        expected_qs = {"_links": ["true"], "_actions": ["false"], "_embedded": ["true"]}
        mock.post("https://api.app.wnology.io/auth/user", json=expected_body, status_code=401)
        creds = {"email": "example@wnology.io", "password": "qwerqwer"}

        with self.assertRaises(WegnologyError) as cm:
    ...
    def test_nested_query_param_call(self, mock):
        ...
        mock.get("https://api.app.wnology.io/applications/anapp/devices", json=expected_body)
    ...
    def test_json_query_param_call(self, mock):
        ...
        mock.get("https://api.app.wnology.io/applications/anapp/events", json=expected_body)
